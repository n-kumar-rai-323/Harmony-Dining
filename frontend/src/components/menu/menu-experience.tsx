...
const promotionalOffer = {
  ...
  title:
    'A little extra for your Harmony moment.',

  description:
    'Discover a curated combination of selected Harmony favourites. Ask our team for current combo inclusions and availability.',

  image:
    '/images/menu/harmony-food-menu-bg.jpg',

  imageAlt:
    'Harmony featured food combo',
};
...
export default function MenuExperience() {
  ...
  const [
    promotionalOfferOpen,
    setPromotionalOfferOpen,
  ] =
    useState(false);
  ...
  useEffect(() => {
    if (
      !promotionalOffer.enabled
    ) {
      return;
    }

    const storageKey =
      'harmony-menu-promo-seen';
  ...
  function closePromotionalOffer() {
    setPromotionalOfferOpen(
      false,
    );
  }

  function exploreOfferMenu() {
    setPromotionalOfferOpen(
      false,
    );
      ...
      >
        ...
        >
          ...
          <Dialog
            ...
            onClose={
              closePromotionalOffer
            }
            fullWidth
            maxWidth="sm"
            aria-labelledby="harmony-promo-title"
            slotProps={{
              paper: {
                sx: {
                  overflow:
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src={
                      promotionalOffer.image
                    }
                    alt={
                      promotionalOffer.imageAlt
                    }
                    fill
                    quality={75}
                ...
                >
                  ...
                  >
                    {
                      promotionalOffer.eyebrow
                    }
                  </Typography>

                  <Typography
                    id="harmony-promo-title"
                    component="h2"
                    variant="h3"
                    sx={{
                      mt: 0.8,
